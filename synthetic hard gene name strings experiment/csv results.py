...
addResults('data fusion results all stats.json')
addResults('data fusion results NED only.json')
addResults('data fusion results with google all stats.json')
addResults('data fusion results with google NED only.json')
