...
results.append({"model": "data fusion with google NED only", "score": ocr_scores, "predictions": img_predictions})

f = open("data fusion results with google NED only.json", "w")
